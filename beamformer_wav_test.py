...
Examples:
  ...
  %(prog)s left.wav right.wav -o output.wav
    ...
    parser.add_argument("left_mic", type=str, help="Path to left microphone WAV file")
    parser.add_argument("right_mic", type=str, help="Path to right microphone WAV file")
    parser.add_argument(
        "-o",
        "--output",
        type=str,
    ...
    if args.output is None:
        ...
        output_filename = (
            f"{left_basename}_beamformed_{args.type}_angle{args.angle:.0f}.wav"
        )
